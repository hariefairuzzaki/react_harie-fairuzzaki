  ...
  return (
    <div>
      <div onSubmit={handleSubmit} style={viewMode}>
        ...
        <button onClick={handleCloseInput} style={{ marginLeft: "10px", marginBottom: "30px" }}>
          Selesai
        </button>
      </div>
      <button className="inputan" onClick={handleOpenInput} style={editMode}>
